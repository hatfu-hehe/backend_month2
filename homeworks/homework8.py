...
#  где таблица заполнялась данными. Сделать функцию get_books_by_author(author), в которой будут запрашиваться данные из
# таблицы books по имени автора, и функцию delete_book_by_id(id), в которой можно удалить книгу по ID
...
book1 = get_books_by_author(connection, 'Fyodor Dostoevsky')
print(book1)
